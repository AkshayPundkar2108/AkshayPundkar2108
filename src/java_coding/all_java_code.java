...
public class all_java_code {
	...
	void fibbonacieSeries() {// fibbonaci series
		int a = 0;
		int b = 1;
		int sum = 0;
	...
	void countDigitingienNumber() {// count a digit in given number
		int num = 856974;
		int count = 0;
		while (num > 0) {
			num = num / 10;
	...
	void someofGivennumber1() {// some of given number
		int num = 123456;
		int sum = 0;
		while (num > 0) {
			sum = sum + num % 10;
	...
	void swappingNumber() {// swap number using third variable
		int a = 10;
		int b = 100;
	...
	void swapnumberwithoutThirdVariable() {// swap number without third variable
		int a = 20;
		int b = 200;
		System.out.println("before swapping= " + "a= " + a + " " + "b= " + b);
		a = a + b;
	...
	void reveresnumberusingwhileLoop() {// reverse number using while loop
		int i = 20;
		while (i >= 0) {
	...
	void forwaordNumberbywhileloop() {
		int i = 0;
		while (i <= 10) {
			System.out.println(i);
			i++;
	...
	void reveresenumberusingforloop() {// reverse number using for loop
	...
	void print_number_without_Loop(int start, int end) {// print 0 to 100 number
		if (start <= end) {
			System.out.println(start);
			print_number_without_Loop(start + 1, end);
		}
	}

	void print_number_without_Loop1(int start, int end) {// print 100 to 0 number
		if (start >= end) {
			System.out.println(start);
			print_number_without_Loop1(start - 1, end);
		}
	}
	...
	void oddevnwhileLoop() {// odd even number using whileloop
		int i = 0;
		while (i < 20) {
			if (i % 2 == 0) {
	...
	void factorialNumber() {
		/*
		 * factorial number are those who is multiply than lower and equal 4!=4*3*2*1=24
		 * 5!=5*4*3*2*1=120 6!=6*5*4*3*2*1
		 */
	...
	void oddevenforloop() {// odd even number using for loop
		for (int i = 10; i >= 0; i--) {
			if (i % 2 == 0) {
	...
	void reverseString() {// reverse string
		String name = "Yogesh";
	...
	void reverseonebyOne() {// reverse string one by ine
		String name = "Yogesh";
		char c;
		String rev = " ";
		for (int i = name.length() - 1; i >= 0; i--) {
	...
	void occurance() {//// give a count of character into string
...
//count a words in given string 
	...
	void countofLcharacterInSentence() {// give a count of single charater from string
		String s = "lala lives in london";
		char c = 'l';
		int count = 0;
		for (int i = 0; i < s.length(); i++) {
	...
	void removefirstandlastletter() {// remove first and last character of the name
		String s = "Yogesh";
	...
	void findmaxnumber() {// find a max number from the array
	...
	void findsecondmax() {// find a second max number fro the array
		int a[] = { 1, 2, 3, 4, 5 };
		int max = a[0];
		int secondmax = a[0];
		for (int i = 0; i < a.length; i++) {
